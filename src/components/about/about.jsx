					...
					<div className="about__content">
						...
						<motion.div variants={fadeIn("up", "", 1, 0.75)}>
							<p>
								...
								passionate about programming. Proficient in PHP
								and Dart, I have a strong understanding of
								frameworks like Laravel and Flutter. Currently,
								I am expanding my skills by learning Node.js,
								particularly focusing on the Express.js
								framework, to build RESTful APIs. As part of the
								Bangkit Academy, I have been exploring cloud
								computing on the Google Cloud Platform (GCP).
								With a strong academic record and participation
								in relevant extracurricular activities, I am
								motivated to continuously improve my skills. I
